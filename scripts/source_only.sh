...
CUDA_VISIBLE_DEVICES=1 python image_source_final.py --root data --output weights --batch_size 64 --dataset OfficeHome --proto_path ./protoruns/run7/prototypes.pth --max_epoch 1000 --source Ar,Pr --target Cl,Rw --wandb 1
